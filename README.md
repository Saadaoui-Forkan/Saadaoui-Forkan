...
I am a diligent web developer with a keen interest in the field of technology. Skilled in developing responsive and secure applications using JavaScript and leveraging frameworks such as React.js and Node.js.

## What I know :computer:
- **Front-end development:**
	I excel in creating interactive and responsiveweb pages and websites using HTML, CSS, JavaScript, and the React.js library.
- **Backend Development**
	I use Node.js for backend development with the Express.js framework and MongoDB databases.
